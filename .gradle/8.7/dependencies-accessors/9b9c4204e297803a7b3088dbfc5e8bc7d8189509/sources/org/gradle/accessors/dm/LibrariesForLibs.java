...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    private final MmkvLibraryAccessors laccForMmkvLibraryAccessors = new MmkvLibraryAccessors(owner);
    ...
    /**
     * Group of libraries at <b>mmkv</b>
     */
    public MmkvLibraryAccessors getMmkv() {
        return laccForMmkvLibraryAccessors;
    }
    ...
    public static class GlideLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Dependency provider for <b>android</b> with <b>com.github.bumptech.glide:glide</b> coordinates and
    ...
    public static class KtorLibraryAccessors extends SubDependencyFactory {
        ...
        private final KtorKotlinLibraryAccessors laccForKtorKotlinLibraryAccessors = new KtorKotlinLibraryAccessors(owner);
        ...
        /**
         * Group of libraries at <b>ktor.kotlin</b>
         */
        public KtorKotlinLibraryAccessors getKotlin() {
            return laccForKtorKotlinLibraryAccessors;
        }
    ...
    public static class KtorContentLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Dependency provider for <b>negotation</b> with <b>io.ktor:ktor-client-content-negotiation</b> coordinates and
         * with version reference <b>ktor</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getNegotation() {
            return create("ktor.content.negotation");
        }

    }

    public static class KtorKotlinLibraryAccessors extends SubDependencyFactory {

        public KtorKotlinLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
         ...
         */
        public Provider<MinimalExternalModuleDependency> getSerialization() {
            return create("ktor.kotlin.serialization");
        }

    }

    public static class MmkvLibraryAccessors extends SubDependencyFactory {

        public MmkvLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>android</b> with <b>com.tencent:mmkv</b> coordinates and
         * with version reference <b>mmkv</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getAndroid() {
            return create("mmkv.android");
        }
    ...
    public static class NavLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Dependency provider for <b>fragment</b> with <b>androidx.navigation:navigation-ui-ktx</b> coordinates and
        ...
        /**
         * Dependency provider for <b>ui</b> with <b>androidx.navigation:navigation-fragment-ktx</b> coordinates and
         * with version reference <b>nav.version</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>mmkv</b> with value <b>1.3.9</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class FirebaseVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>firebase.bom</b> with value <b>32.0.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>firebase.firestore</b> with value <b>24.3.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>firebase.gms</b> with value <b>4.4.2</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getGms() { return getVersion("firebase.gms"); }
    ...
    public static class KoinBundleAccessors extends BundleFactory {
        ...
        /**
         * Dependency bundle provider for <b>koin.bundle</b> which contains the following dependencies:
         * <ul>
         ...
         */
        public Provider<ExternalModuleDependencyBundle> getBundle() {
            return createBundle("koin.bundle");
        }
    ...
    public static class KtorBundleAccessors extends BundleFactory {
        ...
        /**
         * Dependency bundle provider for <b>ktor.bundle</b> which contains the following dependencies:
         * <ul>
         ...
         */
        public Provider<ExternalModuleDependencyBundle> getBundle() {
            return createBundle("ktor.bundle");
        }
    ...
    public static class FirebasePluginAccessors extends PluginFactory {
        ...
        /**
         * Plugin provider for <b>firebase.gms</b> with plugin id <b>com.google.gms.google-services</b> and
         * with version reference <b>firebase.gms</b>
         * <p>
         * This plugin was declared in catalog libs.versions.toml
         */
        public Provider<PluginDependency> getGms() { return createPlugin("firebase.gms"); }
